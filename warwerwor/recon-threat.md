...
❯ rm -rf /tmp/recon026-live
❯ rm -rf hasil
❯ cd ~/Dokumen/Workshop/agent/agent_solidity/threat_agent
❯ source .venv/bin/activate
❯ rm -rf /tmp/threat027-live
❯ rm -rf /tmp/threat-evidence-fix
❯ rm -rf /tmp/threat026-live
