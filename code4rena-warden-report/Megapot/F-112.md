Deliberately increasing liquidity can DoS updates to the protocol’s governance parameters.
Avatar for BengalCatBalu
BengalCatBalu
...
JackpotLPManager.sol#L433Opens in a new window
